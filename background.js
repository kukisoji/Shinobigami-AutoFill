var background = (function () {
            ...
            const onMessageWrappers = new DefaultWeakMap((listener) => {
              ...
              return function onMessage(message, sender, sendResponse) {
                ...
                const isResultThenable =
                  result2 !== true && isThenable(result2);
                if (
                  result2 !== true &&
                  !isResultThenable &&
                  !didCallSendResponse
  ...
  const originalBrowser = /* @__PURE__ */ getDefaultExportFromCjs(
    browserPolyfillExports
  );
